package mrsterner.seraph.client.screen;
...
import mrsterner.seraph.common.registry.SeraphObjects;
...
public class AngelScreenHandler extends ScreenHandler {
    ...
    public AngelScreenHandler(int syncId, AngelMerchant angelMerchant) {
        this(SeraphScreenHandler.ANGEL_SCREEN_HANDLER, syncId, angelMerchant);
    }
    ...
    public class AngelTradeSlot extends Slot {
        ...
        public ItemStack getStack() {
            ...
            if (offer != null) {
                ItemStack angelDeal = new ItemStack(SeraphObjects.ANGEL_DEAL);
                angelDeal.getOrCreateTag().putString("AngelDeal", SeraphRegisters.ANGEL_DEALS.getId(getOffer().getAngelDeal()).toString());
